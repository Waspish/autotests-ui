...
class CoursesListPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.course_edit_menu_item = self.page.get_by_test_id(
            "course-view-edit-menu-item"
        )
        self.course_delete_menu_item = self.page.get_by_test_id(
    ...
    def check_visible_course_card(self, params: CourseCardData):
