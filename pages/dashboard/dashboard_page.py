...
class DashboardPage(BasePage):
    def __init__(self, page: Page):
        ...
        self.students_chart = ChartViewComponent(
            page=page, identifier="students", chart_type="bar"
        )
        self.activities_chart = ChartViewComponent(
            page=page, identifier="activities", chart_type="line"
        )
        self.courses_chart = ChartViewComponent(
            page=page, identifier="courses", chart_type="pie"
        )
        self.scores_chart = ChartViewComponent(
            page=page, identifier="scores", chart_type="scatter"
        )
